...
public class Ejercicio5 : MonoBehaviour
{
    ...
    Matrix4x4 cube2OriginPos;
    Matrix4x4 cube3OriginPos;
    float rotZ;
    ...
    void Start()
    {
        ...
        cube2OriginPos = Transformaciones.Translate(1.5f, 0f, 0f);
        cube3OriginPos = Transformaciones.Translate(2.5f, 0f, 0f);
    }
